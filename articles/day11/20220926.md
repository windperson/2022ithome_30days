...
明天會繼續介紹當正式環境的雲端Azure Table/Blob Storage使用[Managed Identity](https://learn.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/overview)控制存取權限保護資源時，Orleans 的Silo要如何設定Table/Blob Storage Provider。
